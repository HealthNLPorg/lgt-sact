...
class PBJReceiveNode(ConnectionListener):
    ...
    def on_message(self, frame):
        ...
        if frame.body == STOP_MESSAGE:
            ...
            if XMI_INDICATOR in frame.body:
                ...
                # logger.error(f"{self.listener_name} received a malformed message: {frame}")
    ...
    def on_error(self, frame):
        # logger.error(f"{self.listener_name} Receiver Error: {frame}")
    ...
    def start_listening(self):
        ...
        # logger.info(f"{self.listener_name} awaiting CAS on {self.source_host} {self.source_queue} ...")
